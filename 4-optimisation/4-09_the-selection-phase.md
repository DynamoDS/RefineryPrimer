...
Selection is done on the basis of the fitness value created by the fitness function. Individuals with a higher fitness score have better genes. ([See previous section for a fuller discussion of fitness and fitness functions](/4-optimisation/4-08_the-evaluation-phase.md))
